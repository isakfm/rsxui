...
async fn main() {
    let app = Router::new()
        ...
        .route("/components/hover3d", get(pages::hover3d::page))
        .route("/components/hover_gallery", get(pages::hover_gallery::page))
        ...
        .route("/components/link", get(pages::link::page))
        ...
        .route(
            "/components/radial_progress",
            get(pages::radial_progress::page),
        )
        ...
        .route("/components/tooltip", get(pages::tooltip::page))
